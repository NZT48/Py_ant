...
class Spider(GameEntity):
	...
	def __init__(self, world, image):
		...
		#Make a dead spider image by turning it upside down haha
...
class AntStateExploring(State):
	...
	def check_conditions(self):
		...
		#If the ant sees a spider attacking the base, go hunting state
...
class AntStateSeeking(State):
	...
	def check_conditions(self):
		...
		#If leaf is gone, then go back to exloring
...
class AntStateHunting(State):
	...
	def do_actions(self):
		...
		if self.ant.location.get_distance_to(spider.location) < 15.:
			...
			#Give the spider fighting chance to avoid being killed!
			if randint(1, 5) == 1:
				spider.bitten()
	...
	def check_conditions(self):
		...
		#If the spider has been killed then return to the exploring state
		if spider is None:
			return "exploring"
			
		#If the spider gets far enough away, return exploring
